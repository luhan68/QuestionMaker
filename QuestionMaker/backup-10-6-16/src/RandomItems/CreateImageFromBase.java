...
public class CreateImageFromBase {
    ...
    public String Create(String imagename, int quantity1, String imagename2, int quantity2, boolean isplus, boolean isminus) {
        ...
        for (int i = 0; i < quantity1; i++) {
            ...
            ItemOneString = ItemOneString + Globals.GlobalVars.Img_Location + imagename + ".jpg ";

        }
        for (int i = 0; i < quantity2; i++) {
            // loop through the image 1 and add it x times
            ItemTwoString = ItemTwoString + Globals.GlobalVars.Img_Location + imagename2 + ".jpg ";
        ...
        command = "convert " + ItemOneString + IsPlus + IsMinus + ItemTwoString + "+append -size 250x250 xc:none -background none -append " + Globals.GlobalVars.Img_Location + img_name_return;
