 ...
 */
package algorithms.Base10.Level4_6;
 ...
 * @author Karl
 */
public class divide_with_remainders_base10_4_6 {
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = makeAnswer(third, remainder);
        ...
        for (int i = 1; i < 6; i++) { //mix in the random answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                ...
                String answerString = makeAnswer(answer, remainder);
                ...
                String answerString = makeAnswer(randomanswer, remainder);
                results.addElement(answerString);
            }
    ...
    public String makeAnswer(int number, int remainder){
        if(remainder != 0){
            return "Answer " + number + " with remainder of " + remainder;
        }else{
            return "Answer " + number + " with no remainder ";
        }
    }
    ...
    public String CreateHint(String hint, String correct_answer, int first, int second, int third, int remainder) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "___ x " + second + " = " + first + " - " + remainder;
        } else {
            results = hint;
        }
