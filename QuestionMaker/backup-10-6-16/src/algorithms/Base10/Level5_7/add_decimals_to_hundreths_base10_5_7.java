 ...
 * @author Karl
 */
public class add_decimals_to_hundreths_base10_5_7 {
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Make sure to line up the decimal points and number correctly when adding or subtracting decimal numbers. See attached image";
