 ...
 * @author Karl
 */
public class count_246_blank_446_base10_2_2 {
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = first + 100;
            third = first + 200;
            if (third >= low_threshold && correct_answer <= third) { // matches criteria
                String question =  "Fill In The Blank: " + first + "~ __~ " + third;
    ...
    public int plusten(int first) {

        int results = first + 10;
        return results;
    }
    ...
    public String CreateHint(String hint, int correct_answer, int first) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Use the Number Line To Solve The Problem";
