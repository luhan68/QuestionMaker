...
public class FractionsMultiply5_4 {
    ...
    public String CreateHint(String hint, String correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "When multiplying fractions, multitiply the top 2 numbers together, that's your numerator."
                    + " Multiply the bottom 2 numbers together, that's your denominator.";
        } else {
            results = hint;
        }
