 ...
 */
package algorithms.Expressions_Level6_9;
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (third >= low_threshold && third <= high_threshold) { // matches criteria
                String question = "Using The Equation: d = "+first+"h." +
" d = The Dollars Earned And h = The Number Of Hours Worked.  If You Work For " + second + " Hours, How Much Will You Make?";
...
first = first + 1;
    ...
    public String CreateHint(String hint, int first, int second, int third) {
        String results = "Use substitution to solve the problem.";
