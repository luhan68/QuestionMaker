 ...
 * @author Karl
 */
public class HowMuchTip_ratios_7_3 {
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level) {
        ...
        int other_threshold = 30; // for the discount
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (first % 1000 == 0 && second % 5 == 0) { // matches criteria               
                // add question
                String question = "A restaurant bill was $" + first/100 + ". If you wanted to leave a "
                        + second + "% tip, how much is your bill with tip?";
