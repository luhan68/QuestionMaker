 ...
 * @author Karl
 */
public class WholeTimesFrac4_4 {
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            second = fractionHelper.getNumSimplified(); // get simplified num and denom
            third = fractionHelper.getDenomSimplified(); 
            correct_answer = fractionHelper.Fraction_Math("multiply", first, fourth, second, third);
            
            
            if (second < third) { //the question
                String question = first + " x " + second + "/" + third + " =";
