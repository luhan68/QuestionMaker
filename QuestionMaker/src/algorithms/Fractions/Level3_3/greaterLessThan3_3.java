 ...
 * @author Karl
 */
public class greaterLessThan3_3 {
        ...
        for (int i = 1; i < 6; i++) { //mix in the random answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                ...
                do{                  
                    ...
                    three = rn.nextInt(high_threshold - low_threshold) + low_threshold;//num
                    four = two;//denom
    ...
    public String CreateHint(String hint, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "If the denominators are the same, look at the numerators.";
        } else {
            results = hint;
        }
