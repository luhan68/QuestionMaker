...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            do{
                two = rn.nextInt(49) + 51;
            }while(two == 50 || two == one);
            do{
                three = rn.nextInt(49) + 51;
            }while(three == 50 || three == one || three == two);
            do{
                four = rn.nextInt(49) + 51;
            }while(four == 50 || four == one || four == two || four == three);
            ...
            int correct_num = rn.nextInt(40) + 10;
            if(correct_num % 10 == 0){
            ...
            if (true) { 
                //add question
                String question = "Which is equal to half?";
