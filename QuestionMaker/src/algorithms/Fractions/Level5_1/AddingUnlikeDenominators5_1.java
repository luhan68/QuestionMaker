 ...
 * @author Karl
 */
public class AddingUnlikeDenominators5_1 {
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            fractionHelper.Fraction_Math("add", first, second, third, fourth);
            ...
            if (first < second && third < fourth && second != fourth) { //the question
    ...
    public String CreateHint(String hint, String correct_answer, int first, int second, int third, int fourth) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Convert to common denominator and then add together.";
        } else {
            results = hint;
        }
