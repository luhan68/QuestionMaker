 ...
 * @author Karl
 */
public class FindAreaOfCircle_GivenRadius_geo_7_4 {
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = second * Math.pow(first, 2);
            correct_answer = fractionHelper.round(correct_answer, 3); // three decimals
            
            if (true) { // matches criteria               
                // add question
                String question = "Find the area of a circle with radius " + first + " cm";
        ...
        for (int i = 1; i < 6; i++) { //mix in the random answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                results.addElement(correct_answer + " square cm");
                ...
                results.addElement(answer + " square cm");
                inverse_used = true;
                ...
                results.addElement(randomNum + " square cm");
            }
    ...
    public String CreateHint(String hint, double correct_answer, int first, double second) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "The formula for the area of a circle is pi times the radius squared. Remember the radius is half the diameter.";
