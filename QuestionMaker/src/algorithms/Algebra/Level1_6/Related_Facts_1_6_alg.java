package algorithms.Algebra.Level1_6;
 ...
 * @author gene
 */
public class Related_Facts_1_6_alg {
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (third >= low_threshold && third <= high_threshold) { // matches criteria
                String question = first + " + " + second + " = " + third + ". What is the related fact?";
        ...
        for (int i = 1; i < 6; i++) { //mix in the random answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                ...
                String results2 = third + " - " + randomanswer + " = " + first;
    ...
    public String Inverse(int first, int second, int third, int correct) {
        String results = third + " + " + first + " = " + second;
    ...
    public String CreateHint(String hint,  int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Look for the same numbers with the inverse operation." ;
