 ...
 */
package algorithms.Algebra.Level4_2;
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            second = rn.nextInt(high_threshold - first) + first;
      
            correct_answer = second / first;
            if (second % first == 0 && second > first) { // matches criteria
                String question = "The bakery sold " + first + " " + food
                        + " and " + second + " " + food2 + ". How many times more "
                        + food2 + " did they sell than " + food + "?";
