 ...
 */
package algorithms.Algebra.Level2_6;
 ...
 * @author gene
 */
public class If_first_plus_second_equls_third_then_third_minus_what_equals_third1 {
    
    
        public String HintImg = "numberline2.jpg";
        ...
        SubjectType = subjectype;
            ...
            while (found == false) { // try to produce a formula that is within the bounds
                ...
                third = first + second;
                correct_answer = first; // this is the last num
                if (third >= low_threshold && third <= high_threshold) { // matches criteria
                    String question = "If " + first + " + " + second +  " = " + third + "~ then " + third + " + __ = "+ second;
        ...
        public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
            ...
            if (hint.contains("Algorithm Generated")) {
                results = "Use number line. Start at " + third + " and subtract " + second + ".";
