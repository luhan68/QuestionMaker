 ...
 * @author gene
 */
public class A_Plus_b_equals_c_Alg_2_2 {
      public String HintImg = "numberline2.png"; // should be mental strategies?
    public String SubjectType = "OPERATIONS"; // should be algebra?
    public String SubjectImage = "";

    public Vector generategenerate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
