 ...
 */
package algorithms.NumberSystem.Level6_6;
 ...
 * @author Karl
 */
public class NegativeNegativeNumber6_6 {
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        for (int i = 1; i < 6; i++) { //mix in the random answers with the correct answer
            ...
            } else if (inverse_used == false) { //negative
                results.addElement(first * -1);
                inverse_used = true;
            } else if (plusone_used == false) { // * 2
                results.addElement(first * 2);
                plusone_used = true;
            } else if (minusone_used == false) { // 0
                results.addElement(0);
                minusone_used = true;
            } else { // +1
                results.addElement((first + 1) * -1);
            }
