 ...
 * @author Karl
 */
public class NumberDivideByFraction5_7 {
 ...
 public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = fraction.Fraction_Math("divide", whole, whole_deno, numerator, deno);
            // System.out.println(correct_answer);
            //      (numerator * whole_deno) + "/" + (deno * whole) ;
            // boolean match = true;
            //     if (match) { // matches criteria
            if(true){
                String question = whole + " divided by " + Fraction_text + " = ?";
    ...
    public String CreateHint(String hint, int first, int second, int third, int fourth) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Turn the fraction upside down and multiply.";
