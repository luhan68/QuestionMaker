...
public class round_to_whole_base10_5_4 {
    public String HintImg = "placechart_decimals.png"; // rounding charts
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = round(correct_answer, 0);
           
            if (first >= low_threshold && first <= high_threshold) {
                String question = "Round " + first + "." + decimal + " to the nearest whole number";
        ...
        for (int i = 1; i < 6; i++) { //mix in the wrong answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                ...
                String answer = Inverse(correct_answer +3, round_to, rounded_down);
    ...
    public String Inverse(double correct, int round_to, boolean rounded_down) {
