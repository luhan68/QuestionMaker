package algorithms.Base10.Level1_6;

import java.util.Random;
import java.util.Vector;

public class SubtractMultiplesOfTen_BASE10_1_6 {
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Use the hundreds chart. Start at "+ first + " and subtract " + second;
