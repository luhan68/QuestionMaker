 ...
 * @author Karl
 */
public class a_plus_b_plus_c_plus_d_base10_2_6 {
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = first + second + third + fourth;
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second, int third, int fourth) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Use hundreds chart. Start at " + first + "> count up by " + second + "> count up by " + third +
                    " and then count up by " + fourth + ".";
