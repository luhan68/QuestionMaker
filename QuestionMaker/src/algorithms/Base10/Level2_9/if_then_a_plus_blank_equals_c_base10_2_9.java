 ...
 * @author Karl
 */
public class if_then_a_plus_blank_equals_c_base10_2_9 {
    public String HintImg = "";
    public String SubjectType = "100schart.png";
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (third >= low_threshold && third <= high_threshold) { // 0 to 100
                String question = "If " + first + " + " + second + " = " + third
                        + " then " + second + " + __ " + " = " + third;
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Use hundreds chart. Start at " + third + " and count down " + second + "." ;
