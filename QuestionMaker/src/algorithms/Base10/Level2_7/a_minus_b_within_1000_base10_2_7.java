package algorithms.Base10.Level2_7;
 ...
 * @author Karl
 */
public class a_minus_b_within_1000_base10_2_7 {
    public String HintImg = "placechart.png"; // highlight columns
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (correct_answer >= low_threshold && correct_answer <= high_threshold) { // 0 to 100
                if((first + second) >= low_threshold && (first + second) <= high_threshold){
