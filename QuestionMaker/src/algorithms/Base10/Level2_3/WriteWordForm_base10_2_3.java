 ...
 * @author Karl
 */
public class WriteWordForm_base10_2_3 {
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = helper.ConvertNumberToWords(first);
            
            if (first <= high_threshold && first >= low_threshold) {
                String question = "What is " + first + " in word form.";
        ...
        for (int i = 1; i < 6; i++) { //mix in the random answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                ...
                String answer = helper.ConvertNumberToWords(number);
                ...
                String answer = helper.ConvertNumberToWords(randomanswer);
                results.addElement(answer);
            }
    ...
    public String CreateHint(String hint, String correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "An example of word form is four hundred thirty two.";
        } else {
            results = hint;
        }
