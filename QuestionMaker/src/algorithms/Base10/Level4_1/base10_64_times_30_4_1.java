 ...
 * @author Karl
 */
public class base10_64_times_30_4_1 {
    public String HintImg = ""; // rounding charts
...
public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            second = rn.nextInt(60) + 11;
            correct_answer = first * second;
            
            if (first * second <= other_threshold) {
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second) {
        ...
        if (hint.contains("Algorithm Generated")) {
            int firstNoZeros = first/10;
            int secondNoZeros = second;
            
            results = firstNoZeros + "x" + secondNoZeros + " = " + firstNoZeros*secondNoZeros;
            
            //results = "Step 1: multiply " + first + " by " + second + ". Step 2: multiply the answer of Step 1 by 10.";
