package algorithms.Base10.Level2_5;
 ...
 * @author Karl
 */
public class a_minus_b_equals_blank_base10_2_5 {
     public String HintImg = "100schart.png"; // hundreds chart (you can regroup to or from another place with out changing the value)
    ...
    public int Inverse(int first, int second, int high_threshold, int correct) {
        ...
        // This method creates an answer that is the inverse operation of the correct answer
         ...
         if(results > high_threshold){ // is this necessary?
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Use hundreds chart. Start at " + first + " and count down by " + second + ".";
