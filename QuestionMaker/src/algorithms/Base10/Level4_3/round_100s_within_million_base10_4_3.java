 ...
 * @author Karl
 */
public class round_100s_within_million_base10_4_3 {
 ...
 public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        int random_second = 0;
        int round_to = 100; // round to nearest 10
    ...
    public String CreateHint(String hint, int correct_answer, int first) {
        ...
        results = "Is " + first + " closer to " + (first - (first % 100) + " or " + (first - (first % 100) + 100) + "?");
