 ...
 * @author Karl
 */
public class round_nearest_ten_within_million_base10_4_3 {
 ...
 public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        for (int i = 1; i < 6; i++) { //mix in the wrong answers with the correct answer
            ...
            if (i == Random_correct_letter) { //this is the randomly selected letter
                ...
                inverse_used = true;
            } else if (round_100 == false) { // round by 100
                int answer = round(first, 100);
                results.addElement(answer);
                round_100 = true;
            } else if (round_1000 == false) { // round by 1000s
                int answer = round(first, 1000);
                results.addElement(answer);
                round_1000 = true;
    ...
    public String CreateHint(String hint, int correct_answer, int first) {
        ...
        results = "Is " + first + " closer to " + (first - (first % 10) + " or " + (first - (first % 10) + 10) + "?");
