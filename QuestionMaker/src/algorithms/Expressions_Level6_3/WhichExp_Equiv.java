 ...
 */
package algorithms.Expressions_Level6_3;
...
public class WhichExp_Equiv {
 ...
 public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
    ...
    public String Inverse(int first, int second, int third, int correct) {
     String results = (first + second) + "-" + first + "x";
    ...
    public String minusone(int first, int second) {
       ...
       String results = (first * second) + "-" + (first*second) + "x";
    //  String results = "x - " +  first;
        return results;
    }
    
    public String Last(int first, int second ){
        String results =  (first * second) + "-" + (first*second+2) + "x";
   //   String results = "x - " +  (first+1);
    ...
    public String CreateHint(String hint, int first, int second, int third) {
        String results = "Use what you know about distributive property. a(b + c) = ab + ac.";
