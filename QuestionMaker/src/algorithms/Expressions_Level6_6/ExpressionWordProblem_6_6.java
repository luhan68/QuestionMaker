...
public class ExpressionWordProblem_6_6 {
 ...
 public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
    ...
    public String CreateHint(String hint, int first, int second, int third) {
        String results = "A variable represent an unknown. Think about how you would solve the problem if you did know how many miles your car traveled per gallon of gas.";
