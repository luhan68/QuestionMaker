 ...
 */
package algorithms.Counting.Level1_3;
 ...
 * @author gene
 */
public class counting_1_2_3_space_lvel_1_3 {
    
    public String HintImg = "numberline2.png";
    ...
    public Vector generate(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            correct_answer = first + 4;
            int second = first + 1;
            int third = first + 2;
            fourth = first + 3;
            if (correct_answer >= low_threshold && correct_answer <= high_threshold) { // matches criteria
                String question =  "Fill In The Blank: " + first + "~" + second + "~" + third + "~" + fourth + "~__";
        ...
        results.addElement(CreateHint(hint, correct_answer, first, fourth));
    ...
    public String CreateHint(String hint, int correct_answer, int first, int fourth) {
        String results = "";
        if (hint.contains("Algorithm Generated")) {
            results = " Use number line. Start at " + fourth + " and add 1.";
