 ...
 */
package algorithms.Counting.Level1_2;
 ...
 * @author Gene
 */
public class x_plus_y_equal_z_so_z_minus_space_equals_blank_lvl_1_2 {



        public String HintImg = "numberline.png";
        ...
        public Vector generate(int low_threshold, int high_threshold, String hint, String level) {
            ...
            while (found == false) { // try to produce a formula that is within the bounds
                ...
                if (third >= low_threshold && third <= high_threshold) { // matches criteria
                    String question = first + " + " + second +  " = " + third + " Therefore: " + third + " - __ = "+ second;
        ...
        public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
            ...
            if (hint.contains("Algorithm Generated")) {
                results = "Use the Number Line: Start at " + third + "> then subtract " + second;
