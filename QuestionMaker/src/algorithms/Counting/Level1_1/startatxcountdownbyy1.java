 ...
 */
package algorithms.Counting.Level1_1;
 ...
 * @author Gene
 */
public class startatxcountdownbyy1 {
     public String HintImg = "numberline2.png";
    public String SubjectType = "COUNTING";
    public String SubjectImage = "";

  public Vector AddToX(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (correct_answer >= low_threshold && correct_answer <= high_threshold) { // matches criteria
                String question = "Start at " + first +" and count down " + second + ". What number do you get?";
