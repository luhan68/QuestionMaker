 ...
 * @author Gene
 */
public class startatxcountupbyy {
  ...
  public Vector AddToX(int low_threshold, int high_threshold, String hint, String level, String subjectype) {
        ...
        while (found == false) { // try to produce a formula that is within the bounds
            ...
            if (correct_answer >= low_threshold && correct_answer <= high_threshold) { // matches criteria
                String question = "Start at " + first +" and count up " + second + ". What number do you get?";
    ...
    public String CreateHint(String hint, int correct_answer, int first, int second, int third) {
        ...
        if (hint.contains("Algorithm Generated")) {
            results = "Use number line. Start at " + first + " and add " + second + ".";
